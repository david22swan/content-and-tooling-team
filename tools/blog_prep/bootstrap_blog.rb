...
if File.write(File.join('..', '..', 'content', 'blog', 'updates', blog_post_filename), workflow)
  puts "Blog post starting template created in content/blog/updates/#{blog_post_filename}"
end
